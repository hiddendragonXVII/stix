 ...
 */
export type FirstObserved = string;
/**
 * The end of the time window that the data was observed during.
 */
export type LastObserved = string;
/**
 ...
 */
export type LastAccessedTimestamp = string;
/**
 ...
 */
export type EmailSentTimestamp = string;
/**
 ...
 */
export type ProcessCreatedTimestamp = string;
/**
 ...
 */
export type AccountCreatedTimestamp = string;
/**
 * Specifies the expiration date of the account.
 */
export type AccountExpiresTimestamp = string;
/**
 * Specifies when the account credential was last changed.
 */
export type AccountCredentialLastChanged = string;
/**
 * Specifies when the account was first accessed.
 */
export type AccountFirstLogin = string;
/**
 * Specifies when the account was last accessed.
 */
export type AccountLastAccessed = string;
/**
 ...
 */
export type CertificateValidityBeginTimestamp = string;
/**
 * Specifies the date on which the certificate validity period ends.
 */
export type CertificateValidityEndTimestamp = string;
/**
