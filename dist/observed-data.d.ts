 ...
 */
export declare type Timestamp3 = string;
/**
 * Specifies the date/time the directory was last accessed.
 */
export declare type Timestamp4 = string;
/**
 ...
 */
export declare type Timestamp5 = string;
/**
 ...
 */
export declare type Timestamp6 = string;
/**
 * Specifies the date/time the file was last written to/modified.
 */
export declare type Timestamp7 = string;
/**
 * Specifies the date/time the file was last accessed.
 */
export declare type Timestamp8 = string;
/**
 ...
 */
export declare type Timestamp11 = string;
/**
 ...
 */
export declare type Timestamp12 = string;
/**
 * Specifies the expiration date of the account.
 */
export declare type Timestamp13 = string;
/**
 * Specifies when the account credential was last changed.
 */
export declare type Timestamp14 = string;
/**
 * Specifies when the account was first accessed.
 */
export declare type Timestamp15 = string;
/**
 * Specifies when the account was last accessed.
 */
export declare type Timestamp16 = string;
/**
 ...
 */
export declare type Timestamp18 = string;
/**
 * Specifies the date on which the certificate validity period ends.
 */
export declare type Timestamp19 = string;
/**
